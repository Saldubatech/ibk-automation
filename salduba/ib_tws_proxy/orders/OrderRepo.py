...
orderCompanion = RecordMeta(
  ...
  [
    ...
    'delatNeutralClearingAccount',  # str
...
class OrderRepo(Repo[RecordMeta, OrderRecord]):
  ...
  def __init__(self, db: TradingDB, sdTierRepo: SoftDollarTierRepo, orderStatusRepo: OrderStatusRepo) -> None:
