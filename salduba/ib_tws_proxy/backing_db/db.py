from typing import Optional, Type, TypeVar, Generic, Callable, Iterable, Any
...
class Repo(Generic[M, R]):
  def __init__(self, db: TradingDB, record: RecordMeta, hydrator: Callable[[Iterable[Any]], R]) -> None:
    self.db = db
    self.record = record
