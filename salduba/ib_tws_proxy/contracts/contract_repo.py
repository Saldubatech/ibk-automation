...
from salduba.ib_tws_proxy.domain.enumerations import SecType, Exchange, Currency
...
class ContractKey:
  ...
  def __init__(self, symbol: str, secType: SecType, exchange: Exchange, exchange2: Exchange, currency: Currency):
    self.symbol = symbol
...
class ContractRepo(Repo[RecordMeta, ContractRecord]):
  ...
  def __init__(self, db: TradingDB, deltaNeutralContractRepo: DeltaNeutralContractRepo) -> None:
    super().__init__(db, contractCompanion, ContractRecord.hydrate)
