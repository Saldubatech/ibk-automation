...
class Movement:
  ...
  @classmethod
  def fromDFRow(cls, batch: str, r: pd.Series, contractRid: str) -> Self:
    return cls(
      MovementStatus.NEW,
      batch,
      r['Ticker'],
  ...
  def newRecord(self) -> MovementRecord:
    ...
    return MovementRecord(
      ...
      self.batch,  # type: ignore
      self.ticker,  # type: ignore
      self.trade,  # type: ignore
      self.name,  # type: ignore
      self.symbol,  # type: ignore
      self.raw_type,  # type: ignore
      self.country,  # type: ignore
      self.ibk_type,  # type: ignore
      self.currency,  # type: ignore
      self.exchange,  # type: ignore
      self.exchange2,  # type: ignore
      self.contract_key,  # type: ignore
      self.order_key  # type: ignore
    )
