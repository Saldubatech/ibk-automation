...
class DeltaNeutralContractRecord(Record):
  @classmethod
  def hydrate(cls, *args: list[Any]) -> Self:
...
class ContractDetailTagRecord(Record):
  @staticmethod
  def hydrate(*args: list[Any]) -> "ContractDetailTagRecord":
    return ContractDetailTagRecord(args[0], args[1], *args[2:])  # type: ignore
...
class ContractDetailsRecord(Record):
  @staticmethod
  def hydrate(*args: list[Any]) -> "ContractDetailsRecord":
    return ContractDetailsRecord(args[0], args[1], *args[2:])  # type: ignore
